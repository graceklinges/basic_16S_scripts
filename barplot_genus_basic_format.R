...
#look at your top taxa (names command above) and change these names to the top taxa names, 
...
#change x category to one of your variable names
bar_genus = ggplot(ps_rel_genus_melt, x = Exposure_weeks, y=Abundance) + 
...
ggsave(filename="geno_7_bar_genus.png", plot=bar_genus, device="png",  width = 7, height = 4, dpi=500)
